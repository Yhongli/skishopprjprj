...
<body>
 <div class="wrap">
  <div class="page-title">
    ...
    <span class="modular fr"><a href="${ctx }/product_list.jsp" class="pt-link-btn">产品列表</a></span>
  </div>
  <form action="addproducts">
  <table class="list-style">
   <tr>
    <td style="text-align:right;width:15%;">产品名称：</td>
    <td><input name="productname" type="text" class="textBox length-long"/></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td>
     <input name="price" type="text" class="textBox length-short"/>
     <span>元</span>
    </td>
   </tr>
   <tr>
    ...
    <td>
     <input name="discountprice" type="text" class="textBox length-short"/>
     <span>元</span>
    </td>
   </tr>
   <tr>
    <td style="text-align:right;">产品描述：</td>
    <td><input name="description" type="text" class="textBox length-long"/></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td>
     <input name="img1" type="file" id="suoluetu" class="hide"/>
