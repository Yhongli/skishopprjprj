...
<body data-spm="1">
	<div id="page">
		...
		<form id="J_Form" name="J_Form" action="submitOrder" method="post">
			<div>
			...
			<tr class="shop blue-line">
			 ...
			 target="_blank" title="skishop">skishop</a>
			     <span class="seller">卖家：<a href="http://member1.taobao.com/member/user_profile.jhtml?user_id=ac5831c32f47bc9267fcb75b71b5eed6" target="_blank" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.15">（蘑菇小象）</a></span>
...
<%-- 			<input type="hidden" class="J_Quantity" value="${d.user.userid }" name="productid"/> --%>
			<input type="hidden" class="J_Quantity" value="${d.product.id }" name="productid"/>
			 <tr class="item" data-lineid="19614514619:31175333266:35612993875" data-pointRate="0">
			 <td class="s-title">
			   <a href="single.jsp" target="_blank" title="${d.product.description }" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">
			     <img src="${d.product.img1 }" class="itempic"><span class="title J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">
			     <input type="hidden" class="J_Quantity"/>${d.product.name } </span></a>
			   <div class="props">
			 ...
			 <td class="s-amount" data-point-url="">
			         <input type="hidden" class="J_Quantity" value="${d.count }" name="count"/>${d.count }
			 </td>
			 <td class="s-agio">
			...
			<em class="style-normal-bold-black J_ShopPromo_Result"  >折扣</em>
			  </span>
			</li>
			 </ul>
			 </div>
			...
			韵达
			 ...
			 <li class="dib fee">  <span class='price '>
			 <em class="style-normal-bold-red J_FareSum"  >免邮</em>
			  </span>
			</li>
			 </ul>
			 </div>
			...
			<div class="J_AddressConfirm address-confirm">
			 ...
			 <span>&yen;</span><em class="style-large-bold-red"  id="J_ActualFee"  ></em>
			         ...
			         <a href="checkout.jsp"class="back J_MakePoint" target="_top"data-point-url="">返回购物车</a>
			      <!--  <a href="" id="J_Go" class=" btn-go"  data-point-url=""  tabindex="0" title="点击此按钮，提交订单。"> -->
			       <input type="submit" name="Submit" class="button" value="提交订单"><b class="dpl-button"><!-- </b></a> -->
			  </div>
			 </div>
