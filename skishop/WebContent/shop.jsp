			...
			<div class="row">
			  <div class="col-md-12">
				 <div class="header-left">
					 <div class="logo">
						<a href="${ctx }/index.html"><img src="images/logo.png" alt=""/></a>
					 </div>
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="${ctx }/productlist">商店</a></li>
								<li><a href="${ctx }/experiance.html">经验交流</a></li>
								<li><a href="${ctx }/contact.html">联系我们</a></li>	
								<li><a href="${ctx }/show">查看购物车</a></li>								
								<div class="clear"></div>
							</ul>
					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 <div class="check_button"><a href="${ctx }/show">去购物车结算</a></div>
		...
		<div class="container">
			<div class="row shop_box-top">
				...
				<div class="col-md-3 shop_box"><a href="product?id=${p.id }">
					<img src="${ctx }/${p.img1 }" class="img-responsive" alt=""/>
					<span class="new-box">
					...
					<div class="shop_desc">
						...
						<ul class="buttons">
							<li class="cart"><a href="${ctx }/cart/cartadd?productId=${p.id }">加入购物车</a></li>
							<li class="shop_btn"><a href="${ctx }/product">了解更多</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</a></div>
